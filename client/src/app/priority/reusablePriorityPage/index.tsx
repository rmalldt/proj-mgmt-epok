...
function PriorityPage({ priority }: Props) {
  ...
  // Hard coded userId
  // Later the userId will be fetched from separate Auth server
  const userId = 1;
  ...
  return (
    <div className="m-5 p-4">
      ...
      <Header
        ...
        buttonComponent={
          <button
            className="hover: mr-3 rounded bg-blue-primary px-4 py-2 font-bold text-white hover:bg-blue-700"
      ...
      <div className="mb-4 flex justify-start">
        <button
          className={`px-4 py-2 ${view === "list" ? "bg-gray-300" : "bg-white"} rounded`}
          onClick={() => setView("list")}
        >
          List
        </button>
        <button
          className={`px-4 py-2 ${view === "table" ? "bg-gray-300" : "bg-white"} rounded`}
